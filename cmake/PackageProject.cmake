...
function(package_project)
    ...
    set(_oneValueArgs
        ...
        # default to ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_DATADIR}/${NAME} suitable for vcpkg,
        # etc.
    ...
    if(NOT "${_PackageProject_PUBLIC_INCLUDES}" STREQUAL "")
        foreach(_INC ${_PackageProject_PUBLIC_INCLUDES})
            ...
            if(IS_DIRECTORY ${_INC})
                # the include directories are directly installed to the install destination. If you
                # want an `include` folder in the install destination, name your include directory
                # as `include` (or install it manually using `install()` command).
    ...
    install(
        ...
        PUBLIC_HEADER DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/${_PackageProject_NAME}"
                      COMPONENT dev)
